...
impl ToTokens for DeriveRemoteActor {
    fn to_tokens(&self, tokens: &mut proc_macro2::TokenStream) {
        ...
        // For v2, we just implement the trait without linkme registration
        tokens.extend(quote! {
            ...
            // Also implement HasTypeHash for compatibility with the new system
            impl #impl_generics ::kameo::remote_v2::HasTypeHash for #ident #ty_generics #where_clause {
                const TYPE_HASH: ::kameo::remote_v2::TypeHash = 
                    ::kameo::remote_v2::TypeHash::from_bytes(#id.as_bytes());
            }
        });
    }
}
